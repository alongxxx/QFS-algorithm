...
public:
	...
	double EXPComputeSchedulingMetric (RadioBearer *bearer, double spectralEfficiency, int subChannel);
	double ComputeSchedulingMetric1 (RadioBearer *bearer, double spectralEfficiency, int subChannel,double demand , double total);
