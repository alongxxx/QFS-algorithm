...
#ifndef  DLMYALGOPACKETSCHEDULER2_H_  //dl-my-algo-packet-scheduler2
...
public:
	...
	double mlwdf_ComputeSchedulingMetric (RadioBearer *bearer, double spectralEfficiency, int subChannel,double credit_rate,double avg_credit,int demand,double cqi_rate);
