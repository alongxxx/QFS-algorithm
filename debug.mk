...
sleep 2
cd TOOLS; make; cd ../;
make[1]: Entering directory `/home/alongxxx/desktop/LTE_SIM2/TOOLS'
...
[1;36m../src/protocolStack/mac/AMCModule.cpp:288:1: [1;35mwarning:[1;36m control reaches end of non-void function [-Wreturn-type][0m
}
^
...
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:134:37: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int j = 0; j < flows->size (); j++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:172:45: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
if (l_iScheduledFlows == flows->size ())
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:183:40: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int k = 0; k < flows->size (); k++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:236:71: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int rb = 0; rb < flow->GetListOfAllocatedRBs ()->size (); rb++ )
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:269:65: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int rb = 0; rb < flow->GetListOfAllocatedRBs ()->size (); rb++ )
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:121:5: [1;35mwarning:[1;36m unused variable ‘count’ [-Wunused-variable][0m
int count=0;
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:160:7: [1;35mwarning:[1;36m unused variable ‘l_iNumberOfUsers’ [-Wunused-variable][0m
int l_iNumberOfUsers = ((ENodeB*)this->GetMacEntity()->GetDevice())->GetNbOfUserEquipmentRecords();
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler.cpp:164:19: [1;35mwarning:[1;36m unused variable ‘credit_queue’ [-Wunused-variable][0m
static double AUTHORS bugs colorize CONFIG CONTRIBUTORS cqi.txt Debug debug.mk DOC find_parameter getcqi install_list LICENSE Makefile my_make README README.md RELEASE_NOTES run RUN run2 run2~ src tab_complete test test~ TEST.txt TOOLS credit_queue = new double[1000]();
^
In file included from ../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/rlc/rlc-entity.h:27:0,
from ../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/protocol-stack.h:33,
from ../src/protocolStack/mac/packet-scheduler/../../../device/NetworkNode.h:39,
...
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:296:36: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for(int k=0;k<flows->size ();k++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:334:36: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int j = 0; j < flows->size (); j++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:346:40: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int j = 0; j < flows->size (); j++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:354:40: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int j = 0; j < flows->size (); j++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:363:45: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
if (l_iScheduledFlows == flows->size ())
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:377:40: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for(int k=0;k<flows->size ();k++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:391:44: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for(int k=0;k<flows->size ();k++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:406:45: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int k = 0; k < flows->size (); k++)
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:469:71: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int rb = 0; rb < flow->GetListOfAllocatedRBs ()->size (); rb++ )
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:504:65: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
for (int rb = 0; rb < flow->GetListOfAllocatedRBs ()->size (); rb++ )
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:248:7: [1;35mwarning:[1;36m unused variable ‘l_iNumberOfUsers’ [-Wunused-variable][0m
int l_iNumberOfUsers = ((ENodeB*)this->GetMacEntity()->GetDevice())->GetNbOfUserEquipmentRecords();
^
[1;36m../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:257:7: [1;35mwarning:[1;36m unused variable ‘nbCell’ [-Wunused-variable][0m
int nbCell = NetworkManager::Init()->GetNbCell();
^
In file included from ../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/rlc/rlc-entity.h:27:0,
from ../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/protocol-stack.h:33,
from ../src/protocolStack/mac/packet-scheduler/../../../device/NetworkNode.h:39,
from ../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:36:
../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/rlc/../../load-parameters.h: At global scope:
[1;36m../src/protocolStack/mac/packet-scheduler/../../../device/../protocolStack/rlc/../../load-parameters.h:35:13: [1;35mwarning:[1;36m ‘_APP_TRACING_’ defined but not used [-Wunused-variable][0m
static bool _APP_TRACING_ = true;
^
...
static bool _channel_AWGN_ = false;
^
In file included from ../src/protocolStack/mac/packet-scheduler/dl-my-algo-packet-scheduler2.cpp:45:0:
[1;36m../src/protocolStack/mac/packet-scheduler/../../../utility/eesm-effective-sinr.h:29:15: [1;35mwarning:[1;36m ‘beta_value’ defined but not used [-Wunused-variable][0m
static double beta_value [20] = {
^
...
[1;36m../src/flows/radio-bearer.cpp:368:40: [1;35mwarning:[1;36m comparison between signed and unsigned integer expressions [-Wsign-compare][0m
...
Building file: ../src/flows/total_flow.cpp
Invoking: GCC C++ Compiler
g++ -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"src/flows/total_flow.d" -MT"src/flows/total_flow.d" -o"src/flows/total_flow.o" "../src/flows/total_flow.cpp"
Finished building: ../src/flows/total_flow.cpp
...
Building file: ../src/flows/QoS/QoSForMY_algo2.cpp
Invoking: GCC C++ Compiler
g++ -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"src/flows/QoS/QoSForMY_algo2.d" -MT"src/flows/QoS/QoSForMY_algo2.d" -o"src/flows/QoS/QoSForMY_algo2.o" "../src/flows/QoS/QoSForMY_algo2.cpp"
Finished building: ../src/flows/QoS/QoSForMY_algo2.cpp
...
Cell *cell;
^
[1;36m../src/componentManagers/NetworkManager.cpp: [0m[1;30mnote:[0m In member function ‘void NetworkManager::PrintUserPosition1(int)’:
[1;36m../src/componentManagers/NetworkManager.cpp:1135:18: [1;35mwarning:[1;36m unused variable ‘user’ [-Wunused-variable][0m
UserEquipment *user;
^
...
int maxXY = radius AUTHORS bugs colorize CONFIG CONTRIBUTORS cqi.txt Debug debug.mk DOC find_parameter getcqi install_list LICENSE Makefile my_make README README.md RELEASE_NOTES run RUN run2 run2~ src tab_complete test test~ TEST.txt TOOLS 1000; // in metres
^
...
../src/scenarios/multi-cell.h: In function ‘void MultiCell(int, double, int, int, int, int, int, int, int, int, double, int, int, double)’:
[1;36m../src/scenarios/multi-cell.h:134:32: [1;35mwarning:[1;36m variable ‘frame_structure’ set but not used [-Wunused-but-set-variable][0m
FrameManager::FrameStructure frame_structure;
^
...
int nbFemtoCells = nbBuildings AUTHORS bugs colorize CONFIG CONTRIBUTORS cqi.txt Debug debug.mk DOC find_parameter getcqi install_list LICENSE Makefile my_make README README.md RELEASE_NOTES run RUN run2 run2~ src tab_complete test test~ TEST.txt TOOLS femtoCellsInBuilding;
^
...
int maxXY = cell->GetRadius () AUTHORS bugs colorize CONFIG CONTRIBUTORS cqi.txt Debug debug.mk DOC find_parameter getcqi install_list LICENSE Makefile my_make README README.md RELEASE_NOTES run RUN run2 run2~ src tab_complete test test~ TEST.txt TOOLS 1000;
^
...
AUTHORS bugs colorize CONFIG CONTRIBUTORS cqi.txt Debug debug.mk DOC find_parameter getcqi install_list LICENSE LTE-Sim Makefile my_make README README.md RELEASE_NOTES run RUN run2 run2~ src tab_complete test test~ TEST.txt TOOLS
