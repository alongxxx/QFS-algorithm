...
bandwidth=${11} # setear en el archivo compute_spectral_efficiency
time=${10} # setear en el archivocompute_spectral_efficiency
...
# GRAPHIC FOR PROPORTIONAL FAIRNESS	
	...
	./compute_spectral_efficiency.sh tmp $time $bandwidth >> temporal
	rm tmp
	 let COUNT=COUNT+1
	done
