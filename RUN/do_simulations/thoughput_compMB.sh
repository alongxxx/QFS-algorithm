...
until [ $NBUE -gt $2 ]; do
	...
	./compute_throughputMB.sh tmp $time $(( ${NBUE}*${CELS} )) >> temporal
	rm tmp
	 let COUNT=COUNT+1
	done
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat $7-Throughput Users Throughput[Mbps] MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
