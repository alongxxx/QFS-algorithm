...
i=0
cat results_Fairness-Index2_Total.ods | grep -A $grep_line  "^PF$" | grep -A $grep_line2 "Users Value" |grep -v "Users Value" >tmp
while read line
do
	var1=$(echo $line | grep -o "\s.*$")
...
i=0
cat results_Fairness-Index2_Total.ods | grep -A $grep_line  "^MLWDF$" | grep -A $grep_line2 "Users Value" |grep -v "Users Value" >tmp
while read line
do
	var1=$(echo $line | grep -o "\s.*$")
	array1[$i]=$(echo ${array1[$i]}+$var1 | bc -l)
...
i=0
cat results_Fairness-Index2_Total.ods | grep -A $grep_line  "^EXP-PF$" | grep -A $grep_line2 "Users Value" |grep -v "Users Value" >tmp
while read line
do
	var1=$(echo $line | grep -o "\s.*$")
	array1[$i]=$(echo ${array1[$i]}+$var1 | bc -l)
...
i=0
cat results_Fairness-Index2_Total.ods | grep -A $grep_line  "^my_algo$" | grep -A $grep_line2 "Users Value" |grep -v "Users Value" >tmp
while read line
do
	var1=$(echo $line | grep -o "\s.*$")
	array1[$i]=$(echo ${array1[$i]}+$var1 | bc -l)
...
i=0
cat results_Fairness-Index2_Total.ods | grep -A $grep_line  "^my_algo2$" | grep -A $grep_line2 "Users Value" |grep -v "Users Value" >tmp
while read line
do
	var1=$(echo $line | grep -o "\s.*$")
	array1[$i]=$(echo ${array1[$i]}+$var1 | bc -l)
