...
until [ $NBUE -gt $2 ]; do
	...
	grep "RX "$7".*C 1"   $TOTALNAME  | grep "D" | awk '{print $14}'  > tmp
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat $7-$8-Delay Users Delay[Sec] MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
...
echo  Cell-Center-Delay $7 REPORT FINISHED!! 
