...
until [ $NBUE -gt $2 ]; do
	...
	TOTALNAME=$FILE"_"$COUNT"_"$FILENAME"_PF_"$NBUE"U"$CELS"C"".sim"
		...
		grep "RX "$7".*C 1"   $TOTALNAME  | awk '{print $8+5}'  > tmp
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat $7-$8-Throughput Users Throughput[Mbps] MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
...
echo Cell-Center-thoughputMBPF $7 REPORT FINISHED!! 
