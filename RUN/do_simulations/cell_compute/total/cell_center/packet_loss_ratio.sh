...
until [ $NBUE -gt $2 ]; do
	...
	grep "RX.*C 1"   $TOTALNAME  | awk '{print $1}'  > tmp
	grep "TX "   $TOTALNAME  | awk '{print $1}'  >> tmp
...
./Graph1.sh $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat  $7-$8-Packet-Loss-Ratio Users PLR MY_algo_Y1_$8_$7.dat MY_algo2_Y1_$8_$7.dat
...
echo  Cell-Center-PLR REPORT FINISHED!! 
