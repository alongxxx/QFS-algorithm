...
# echo "set xtics ($labelxtic)" >> $filename
 ...
 echo "plot  '$2' using 2:xtic(1) title 'PF', '$3' using 2:xtic(1) title 'MLWDF', '$4' using 2:xtic(1) title 'EXP/PF','$8' using 2:xtic(1) title 'Max_CQI','$9' using 2:xtic(1) title 'my_algo'" >>$filename
gnuplot $filename
rm -Rf $filename
